          ...
          <div id="data-entries container">
            <div class=" row">
              <div class="col-md-6"> <label for="id">Map ID</label>
                ...
                <input type="text" name="ikr_size" placeholder="size sq. ft" id="ikr_size2" />

                <label class="" for="room-build">Room Build</label>
                <input type="text" name="room-build" placeholder="e.g 50000" id="ikr_room_build_m" />
                ...
                <div class=" d-flex justify-content-start  align-items-baseline" style="gap: 15px;">
                  ...
                  <div class="form-check p-0 mt-1">
                    <input value="sponsored" class="" type="radio" name="room-build-sponsore" id="room-build-sponsore_m">
                    <label class="form-check-label" for="room-build-sponsore">
                      Sponsored
                    </label>
                  </div>
                  <div class="form-check p-0 mt-1">
                    <input value="available" class="" type="radio" name="room-build-sponsore" id="room-furniture-sponsor_am" checked>
              ...
              <div class="col-md-6">
                ...
                <input type="text" name="room-furnish" placeholder="e.g 50000" id="ikr_room_furnish_m" />
                ...
                <div class=" d-flex justify-content-start  align-items-baseline" style="gap: 15px;">
                  ...
                  <div class="form-check p-0 mt-1">
                    <input value="sponsored" class="" type="radio" name="room-furnished-sponsore" id="room-furnished-sponsore1_m">
